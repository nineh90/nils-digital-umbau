...
class ServiceCategoryResource extends Resource
{
    ...
    protected static ?string $modelLabel = 'Leistungsgruppe';

    protected static ?string $pluralModelLabel = 'Leistungsgruppen';

    protected static string|\UnitEnum|null $navigationGroup = 'Leistungen';
