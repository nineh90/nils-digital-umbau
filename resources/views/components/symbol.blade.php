...
{{--
    ...
    Keine Icon-Bibliothek: fünfzehn Pfade rechtfertigen keine weitere
    Abhängigkeit im Bau. Neue Symbole kommen einfach in die Liste unten.
...
@php
     ...
     * ein Fehler. So bleibt eine Kachel benutzbar, deren Symbol im Admin
     * versehentlich falsch geschrieben wurde.
     */
    $pfad = $pfade[$name] ?? '<circle cx="12" cy="12" r="9"/>';
@endphp
